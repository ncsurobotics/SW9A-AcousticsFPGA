...
function [ref_dataOut,ref_validOut] = hilbert_fir_filter_cosim(dataIn,validIn,resetIn)

coder.extrinsic('hilbert_fir_filter_sysobj_cosim');
...
[ref_dataOut,ref_validOut] = hilbert_fir_filter(dataIn,validIn,resetIn);

% Run cosimulation
[dataOut,validOut] = hilbert_fir_filter_sysobj_cosim(dataIn,validIn,resetIn);
