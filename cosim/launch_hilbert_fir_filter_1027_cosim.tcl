...
if {[file exists xsim.dir] == 1} {
 ...
 set hdlsrc {C:\Users\Aweso\Verilog\Aquapack\bartlett\sim\bartlett_datapath\codegen\hilbert_fir_filter_1027\hdlsrc}
...
exec xvlog $hdlsrc/hilbert_fir_filter_1027.v

exec xelab hilbert_fir_filter_1027 --timescale 1ps/1ps --override_timeunit --override_timeprecision -dll --snapshot design -debug wave 
