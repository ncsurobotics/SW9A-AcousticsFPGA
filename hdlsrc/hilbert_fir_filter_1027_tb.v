// -------------------------------------------------------------
// 
// File Name: C:\Users\Aweso\Verilog\Aquapack\bartlett\sim\bartlett_datapath\codegen\hilbert_fir_filter_1027\hdlsrc\hilbert_fir_filter_1027_tb.v
// Created: 2025-10-27 17:59:43
// 
...
// -------------------------------------------------------------
// 
// Module: hilbert_fir_filter_1027_tb
// Source Path: 
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module hilbert_fir_filter_1027_tb;
  ...
  wire snkDonen;
  wire ce_out;
  wire signed [31:0] dataOut;  // sfix32_En29
  wire validOut;
  ...
  reg signed [31:0] dataOut_expected;  // sfix32_En29
  reg signed [31:0] status_dataOut_expected;  // sfix32
  wire signed [31:0] dataOut_ref;  // sfix32_En29
  ...
  // Data source for resetIn
  assign rawData_resetIn = 1'b0;
  ...
  // holdData reg for resetIn
  always @(posedge clk or negedge reset)
    begin : stimuli_resetIn
      if (!reset) begin
        holdData_resetIn <= 1'bx;
      end
      else begin
        holdData_resetIn <= rawData_resetIn;
      end
    end

  always @(rawData_resetIn or rdEnb)
    begin : stimuli_resetIn_1
      if (rdEnb == 1'b0) begin
        resetIn_offset <= holdData_resetIn;
      end
      else begin
        resetIn_offset <= rawData_resetIn;
      end
    end

  assign #2 resetIn_1 = resetIn_offset;
  ...
  hilbert_fir_filter_1027 u_hilbert_fir_filter_1027 (.clk(clk),
                                                     .reset(reset),
                                                     .clk_enable(enb),
...
endmodule  // hilbert_fir_filter_1027_tb
