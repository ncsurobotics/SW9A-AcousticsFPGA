...
real_part = randi([-32767,32767], rows, cols) %randi([-32768, 32767], rows, cols); % 16-bit signed integers
imag_part = randi([-32767,32767], rows, cols) %randi([-32768, 32767], rows, cols);
