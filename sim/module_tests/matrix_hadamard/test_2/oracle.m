...
for i = 1:4
    for j = 1:4
        real_hex = dec2hex(typecast(int64(real(result(i, j))), 'int64'), 16); % Convert real to hex
        imag_hex = dec2hex(typecast(int64(imag(result(i, j))), 'int64'), 16); % Convert imag to hex
