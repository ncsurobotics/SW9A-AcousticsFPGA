...
#
# Generated by export_simulation on Wed Jan 07 21:19:08 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './RING_BUFFER_RAM.sh' script.

./RING_BUFFER_RAM.sh -reset_run
...
./RING_BUFFER_RAM.sh -noclean_files

For more information on the script, please type './RING_BUFFER_RAM.sh -help'.
